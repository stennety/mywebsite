...
يمكن إجراء هذه التحليلات على جميع الروايات في الشكل التالي عينة عشوائية من تطبيق نفس هذا التحليل على روايات أخرى، الشكل التالي يمثل المخطط الشبكي للعلاقات بين الشخصيات لروايتي "الحديقة السرية"، و" "ورود غرقت من دماء الشياطين"
...
الكود المصدر لتحليل الشخصيات: https://github.com/LailaMB/Rewayatech-Saudi-Stories/blob/master/Rewayatech.ipynb
