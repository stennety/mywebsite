...
While virtual environments aren't subject to real world forces, to feel sufficiently immersed, some measure of realism should be delivered. At the very least, even in highly stylised environments, a sense of scale, proportion and  'solidity' should be maintained.
...
Without meaning to stuff traditional architectural theory down VR space designers' throats, there are some important elements from architecture and its long history, absent from contemporary VR experiences, that really should be given greater credence; I'll discuss some of these below.
...
With the 1st solution, users can find themselves becoming 'lost' in the 'dark zone' behind walls and other so-called barriers; this is highly disconcerting. The 2nd solution can mess up room-scale playspace setup and having the entire world moving along with the head seems weird.
