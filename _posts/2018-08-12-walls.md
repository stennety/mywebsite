...
Without meaning to stuff traditional architectural theory down VR space designers' throats, there are some important elements often absent from contemporary VR experiences that really should be given greater credence; I'll discuss some of these below.
...
While Architects have been pushing boundaries since time immemorial, their attempts at structural gymnastics ultimately exist within the realms of physical possibility. 

Often the very first architectural act is that of defining boundaries. Without boundaries the potential for space creation doesn't exist. These boundaries can range from fuzzy, psychological, boundaries right through to thick, impenetrable walls; indeed, wall masses are often 'celebrated' by revealing and displaying their thickness in full view, creating an added sense of reassurance.
